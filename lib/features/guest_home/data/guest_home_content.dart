...
abstract final class GuestHomeContent {
  ...
  static const String notYourFaultSectionTitle = '의지력의 문제가\n아니었어요';
  static const String notYourFaultMessage1 =
      '체중 관리가 어려웠던 건\n당신의 의지가 약해서가 아니에요.';
  static const String notYourFaultMessage2 =
      '우리 몸에는 식욕을 조절하는 호르몬 시스템이 있어요.\n'
      '이 시스템의 균형이 깨지면 아무리 노력해도 힘들 수밖에 없죠.';
  static const String notYourFaultMessage3 =
      'GLP-1은 이 균형을 다시 맞춰주는 역할을 해요.';
  static const String notYourFaultFooter = '이제, 도움을 받아도 괜찮아요.';
  ...
  // ============================================
  // 섹션 2.5: Food Noise (신규)
  // ============================================

  static const String foodNoiseSectionTitle = '머릿속 음식 생각,\n줄어들 거예요';
  static const String foodNoiseSubtitle = '혹시 이런 경험 있으신가요?';

  static const List<String> foodNoiseQuotes = [
    '배고프지도 않은데 자꾸 뭔가 먹고 싶어...',
    '방금 먹었는데 벌써 다음 끼니 생각이...',
    '다이어트 중인데 음식 생각을 멈출 수가...',
  ];

  static const String foodNoiseExplanation =
      '이걸 "Food Noise"라고 불러요.\n'
      '끊임없이 울리는 음식에 대한 생각들이죠.';

  static const String foodNoisePrediction =
      'GLP-1 치료 후, 이 소음이 약 84% 줄어들어요.\n'
      '마음이 조용해지는 걸 느낄 거예요.';

  static const String foodNoiseFooter =
  ...
  static const String howItWorksSectionTitle = '이렇게\n도와드려요';
  static const String howItWorksSubtitle = '두 곳에서 동시에 작용해요.';

  static const List<Map<String, String>> howItWorksMechanisms = [
    {
      'id': 'brain',
      'icon': '🧠',
      'title': '뇌에서',
      'description': '포만감 신호를 강화하고\n음식 보상 반응을 조절해요.',
    },
    {
      'id': 'stomach',
      'icon': '🫃',
      'title': '위에서',
      'description': '음식 소화 속도를 조절하고\n포만감을 오래 유지시켜요.',
    },
  ];

  static const List<String> howItWorksChecks = [
    '억지로 참는 게 아니에요',
    '자연스럽게 덜 먹게 돼요',
    '선택의 여유가 생겨요',
  ];

  static const String howItWorksFooter = '의지력 싸움에서 벗어나세요.';
  ...
  static const String injectionGuideSectionTitle = '주사,\n생각보다 간단해요';
  static const String injectionGuideSubtitle =
      '처음엔 누구나 긴장돼요.\n하지만 한 번 해보면 "이게 끝?" 할 거예요.';

  static const List<Map<String, String>> injectionSites = [
    {
      'id': 'abdomen',
      'icon': '🤰',
      'name': '복부',
  ...
  static const List<String> injectionReassurance = [
    '바늘이 머리카락보다 가늘어요',
    '대부분 거의 못 느껴요',
    '버튼 누르면 10초 안에 끝',
  ];

  static const List<String> injectionTips = [
    '매주 부위를 돌아가며',
    '주사 전 심호흡 한 번',
    '펜의 바늘 가림막으로 안심',
  ];

  static const String injectionFooter = '걱정하지 마세요, 금방 익숙해져요.';
