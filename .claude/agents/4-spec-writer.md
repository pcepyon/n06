...
docs/userflow.md의 {N}번 기능에 대한 상세 유스케이스를 작성하고, `/docs/00N/spec.md` 경로에 저장하라. 다음 내용을 포함해라.
...
ai agent가 이해하기 쉽게 간결, 명확하게 불필요한 내용은 제외하고 꼭 필요한 내용은 빠뜨리지 말고 작성하라. 에이전트를 병렬로 실행하라.