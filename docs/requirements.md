...
| **SC3. 심각한 증상 대응** | 사용자는 구토가 24시간 이상 지속되고 물도 마실 수 없게 되자 불안해한다. 앱의 **증상 체크** 기능을 통해 해당 증상을 선택하고, 즉시 "전문가와 상담이 필요합니다" 안내를 받는다. 앱에 저장된 연락처를 통해 바로 전화를 걸어 신속하게 대처한다. |
